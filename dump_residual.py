# -*- coding: utf-8 -*-
"""Dump full residual English text nodes for target pages."""
import os, re
...
PAGES = [
 ...
 'algorithms/foc/overmodulation.zh.html',
 'algorithms/foc/comparison-6step.zh.html',
 'algorithms/flux_control/flux_weakening.zh.html',
 'algorithms/dynlimit-simple.zh.html',
 'algorithms/qei.zh.html',
 'algorithms/qei_sync/align.zh.html',
 'algorithms/qei_sync/common.zh.html',
 'algorithms/qei_sync/pullout.zh.html',
 'algorithms/startup.zh.html',
 'algorithms/voltage-control.zh.html',
 'appendix/glossary.zh.html',
 'architecture/codegen.zh.html',
 'architecture/naming.zh.html',
 'components/diagnostics.zh.html',
 'components/supervisory.zh.html',
 'genindex.zh.html',
 'implementation/custom-board-support/configuration.zh.html',
 'implementation/custom-board-support/custom_board_definitions.zh.html',
 'implementation/custom-board-support/verification.zh.html',
 'implementation/resource-usage.zh.html',
 'implementation/ui-customization.zh.html',
 'search.zh.html',
]

for rel in PAGES:
    zh_path = os.path.join(ROOT, rel.replace('/', os.sep))
    ...
    for s in b.descendants:
        ...
        if EN_WORDS.search(text):
            print(f'  [{idx}] PARENT=<{parent.name} class={classes}>')
            print(f'      TEXT={text!r}')
            idx += 1
